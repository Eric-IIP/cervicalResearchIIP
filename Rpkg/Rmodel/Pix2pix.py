...
#   lab, res = generate_images(generator, inp, tar)
#   results.append(res)
#   labels.append(lab)
...
# print(labels[0])
# save_images("./result/pix2pix/result/", label_test_filenames, results)
# save_images("./result/pix2pix/label/", label_test_filenames, labels)