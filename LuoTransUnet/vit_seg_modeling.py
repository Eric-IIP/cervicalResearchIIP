...
import LuoTransUnet.vit_seg_configs as configs
from LuoTransUnet.vit_seg_modeling_resnet_skip import ResNetV2
from torchsummary import summary
from LuoTransUnet.roiGenerate import ROIGenerator
...
class VisionTransformer(nn.Module):
    def __init__(self, config, img_size=224, num_classes=21843, zero_head=False, vis=False, bMask = False, kernel_size: int = 1, kernel_out_channels: int = 1):
        ...
        # fusion part    
        self.fusion = nn.Conv2d(45, out_channels = kernel_out_channels, kernel_size = kernel_size, padding="same")
        ...
        self.transformer = Transformer(config, img_size, vis, in_channels = kernel_out_channels)
